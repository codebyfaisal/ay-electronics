...
const TeamMember = ({ role, name, image, linkedin, github }) => (
  <div
    className="group relative overflow-hidden bg-[rgb(var(--bg-secondary))] border border-[rgb(var(--border))]"
    style={{
      borderRadius: "11rem 11rem 3rem 3rem",
    }}
  >
    <div className="aspect-square rounded-full w-full overflow-hidden relative">
      <img
        src={image}
        alt={name}
