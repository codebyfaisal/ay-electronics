// import { createDailyTransactionSchema, createInvestmentSchema, createMonthlySummarySchema, getSummaryByMonthSchema, updateDailyTransactionSchema, updateInvestmentSchema } from "../schemas/finance.schema.js";
...
// import { createMonthlySummary, deleteMonthlySummary, getMonthlySummaries, getSummaryByMonth } from "../services/monthlySummary.service.js";
// import { createHandler, deleteHandler, getManyHandler, getSummaryHandler, updateHandler } from "./generic.controller.js";
...
// export const handleGetMonthlySummaries = getManyHandler(
//     getMonthlySummaries,
//     monthly,
// )

// export const handleGetMonthlySummary = getSummaryHandler(
//     getSummaryByMonthSchema,
//     getSummaryByMonth,
//     monthly
// )

// export const handleCreateMonthlySummary = createHandler(
//     createMonthlySummarySchema,
//     createMonthlySummary,
//     monthly
// );

// export const handleDeleteMonthlySummary = deleteHandler(
//     idSchema,
...
import { createInvestment, deleteInvestment, getInvestments, updateInvestment } from "../services/investment.service.js";
import { createDailyTransaction, deleteDailyTransaction, getDailyTransactions, updateDailyTransaction } from "../services/dailyTransaction.service.js";
import { deleteSummary, generateDashboardSummary, generateSummary, getSummaries } from "../services/monthlySummary.service.js";
import { createHandler, deleteHandler, getManyHandler, getSummaryHandler, updateHandler } from "./generic.controller.js";
import { idSchema } from "../schemas/common.schema.js";
...
export const handleGetSummary = getSummaryHandler(
    getSummarySchema,
